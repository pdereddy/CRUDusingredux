...
import { addUserContact, editUserContact } from '../redux/actions/usersAction';
      ...
      <div className="modal-body">
        <form>
          ...
          <div className="form-group">
            ...
            <input type="text" className="form-control" id="formGroupExampleInput3" placeholder="PhoneNumber" value={user.PhoneNumber} onChange={(e) => addEditUserInfo("PhoneNumber", e.target.value)} />
          </div>
          <div className="form-group">
            <label htmlFor="formGroupExampleInput2">Email</label>
            <input type="text" className="form-control" id="formGroupExampleInput4" placeholder="Email" value={user.Email} onChange={(e) => addEditUserInfo("Email", e.target.value)} />
          </div>
        </form>
      </div>
